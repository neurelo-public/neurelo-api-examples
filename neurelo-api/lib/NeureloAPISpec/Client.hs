...
module NeureloAPISpec.Client where
...
dispatchLbs
  ...
  -> NeureloAPISpecConfig -- ^ config
  -> NeureloAPISpecRequest req contentType res accept -- ^ request
