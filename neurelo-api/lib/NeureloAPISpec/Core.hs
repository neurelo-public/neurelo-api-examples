...
module NeureloAPISpec.Core where
...
-- * NeureloAPISpecConfig

-- |
data NeureloAPISpecConfig = NeureloAPISpecConfig
...
-- | display the config
instance P.Show NeureloAPISpecConfig where
  show c =
    T.printf
...
-- | constructs a default NeureloAPISpecConfig
--
-- configHost:
--
-- @https://us-east-2.aws.neurelo.dev@
--
-- configUserAgent:
--
-- @"neurelo-api-spec/0.1.0.0"@
--
newConfig :: IO NeureloAPISpecConfig
newConfig = do
    logCxt <- initLogContext
    return $ NeureloAPISpecConfig
        { configHost = "https://us-east-2.aws.neurelo.dev"
        , configUserAgent = "neurelo-api-spec/0.1.0.0"
...
addAuthMethod :: AuthMethod auth => NeureloAPISpecConfig -> auth -> NeureloAPISpecConfig
addAuthMethod config@NeureloAPISpecConfig {configAuthMethods = as} a =
  config { configAuthMethods = AnyAuthMethod a : as}

-- | updates the config to use stdout logging
withStdoutLogging :: NeureloAPISpecConfig -> IO NeureloAPISpecConfig
...
withStderrLogging :: NeureloAPISpecConfig -> IO NeureloAPISpecConfig
...
withNoLogging :: NeureloAPISpecConfig -> NeureloAPISpecConfig
withNoLogging p = p { configLogExecWithContext =  runNullLogExec}

-- * NeureloAPISpecRequest
...
data NeureloAPISpecRequest req contentType res accept = NeureloAPISpecRequest
  { rMethod  :: NH.Method   -- ^ Method of NeureloAPISpecRequest
  , rUrlPath :: [BCL.ByteString] -- ^ Endpoint of NeureloAPISpecRequest
  , rParams   :: Params -- ^ params of NeureloAPISpecRequest
  , rAuthTypes :: [P.TypeRep] -- ^ types of auth methods
  }
  deriving (P.Show)

-- | 'rMethod' Lens
rMethodL :: Lens_' (NeureloAPISpecRequest req contentType res accept) NH.Method
rMethodL f NeureloAPISpecRequest{..} = (\rMethod -> NeureloAPISpecRequest { rMethod, ..} ) <$> f rMethod
{-# INLINE rMethodL #-}

-- | 'rUrlPath' Lens
rUrlPathL :: Lens_' (NeureloAPISpecRequest req contentType res accept) [BCL.ByteString]
rUrlPathL f NeureloAPISpecRequest{..} = (\rUrlPath -> NeureloAPISpecRequest { rUrlPath, ..} ) <$> f rUrlPath
{-# INLINE rUrlPathL #-}

-- | 'rParams' Lens
rParamsL :: Lens_' (NeureloAPISpecRequest req contentType res accept) Params
rParamsL f NeureloAPISpecRequest{..} = (\rParams -> NeureloAPISpecRequest { rParams, ..} ) <$> f rParams
{-# INLINE rParamsL #-}

-- | 'rParams' Lens
rAuthTypesL :: Lens_' (NeureloAPISpecRequest req contentType res accept) [P.TypeRep]
rAuthTypesL f NeureloAPISpecRequest{..} = (\rAuthTypes -> NeureloAPISpecRequest { rAuthTypes, ..} ) <$> f rAuthTypes
{-# INLINE rAuthTypesL #-}
...
class HasBodyParam req param where
  setBodyParam :: forall contentType res accept. (Consumes req contentType, MimeRender contentType param) => NeureloAPISpecRequest req contentType res accept -> param -> NeureloAPISpecRequest req contentType res accept
  setBodyParam req xs =
...
class HasOptionalParam req param where
  ...
  applyOptionalParam :: NeureloAPISpecRequest req contentType res accept -> param -> NeureloAPISpecRequest req contentType res accept
  applyOptionalParam = (-&-)
  {-# INLINE applyOptionalParam #-}

  -- | infix operator \/ alias for 'addOptionalParam'
  (-&-) :: NeureloAPISpecRequest req contentType res accept -> param -> NeureloAPISpecRequest req contentType res accept
  (-&-) = applyOptionalParam
  {-# INLINE (-&-) #-}
...
-- ** NeureloAPISpecRequest Utils

_mkRequest :: NH.Method -- ^ Method
          -> [BCL.ByteString] -- ^ Endpoint
          -> NeureloAPISpecRequest req contentType res accept -- ^ req: Request Type, res: Response Type
_mkRequest m u = NeureloAPISpecRequest m u _mkParams []
...
removeHeader :: NeureloAPISpecRequest req contentType res accept -> [NH.HeaderName] -> NeureloAPISpecRequest req contentType res accept
...
_setContentTypeHeader :: forall req contentType res accept. MimeType contentType => NeureloAPISpecRequest req contentType res accept -> NeureloAPISpecRequest req contentType res accept
_setContentTypeHeader req =
    case mimeType (P.Proxy :: P.Proxy contentType) of
        Just m -> req `setHeader` [("content-type", BC.pack $ P.show m)]
        Nothing -> req `removeHeader` ["content-type"]

_setAcceptHeader :: forall req contentType res accept. MimeType accept => NeureloAPISpecRequest req contentType res accept -> NeureloAPISpecRequest req contentType res accept
...
addForm :: NeureloAPISpecRequest req contentType res accept -> WH.Form -> NeureloAPISpecRequest req contentType res accept
addForm req newform =
...
_addMultiFormPart :: NeureloAPISpecRequest req contentType res accept -> NH.Part -> NeureloAPISpecRequest req contentType res accept
...
_setBodyBS :: NeureloAPISpecRequest req contentType res accept -> B.ByteString -> NeureloAPISpecRequest req contentType res accept
_setBodyBS req body =
    req & L.set (rParamsL . paramsBodyL) (ParamBodyB body)

_setBodyLBS :: NeureloAPISpecRequest req contentType res accept -> BL.ByteString -> NeureloAPISpecRequest req contentType res accept
_setBodyLBS req body =
    req & L.set (rParamsL . paramsBodyL) (ParamBodyBL body)

_hasAuthType :: AuthMethod authMethod => NeureloAPISpecRequest req contentType res accept -> P.Proxy authMethod -> NeureloAPISpecRequest req contentType res accept
...
class P.Typeable a =>
  ...
  applyAuthMethod
    ...
    -> a
    -> NeureloAPISpecRequest req contentType res accept
    -> IO (NeureloAPISpecRequest req contentType res accept)
...
_applyAuthMethods
  ...
  -> NeureloAPISpecConfig
  -> IO (NeureloAPISpecRequest req contentType res accept)
_applyAuthMethods req config@(NeureloAPISpecConfig {configAuthMethods = as}) =
  foldlM go req as
  where
