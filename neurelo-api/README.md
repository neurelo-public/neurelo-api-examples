## OpenAPI Auto-Generated [http-client](https://www.stackage.org/lts-10.0/package/http-client-0.5.7.1) Bindings to `Neurelo API Spec`

The library in `lib` provides auto-generated-from-OpenAPI [http-client](https://www.stackage.org/lts-10.0/package/http-client-0.5.7.1) bindings to the Neurelo API Spec API.
...
| baseModule                      | Set the base module namespace                                                                                                 |          | NeureloAPISpec                      |
| cabalPackage                    | Set the cabal package name, which consists of one or more alphanumeric words separated by hyphens                             |          | neurelo-api-spec                    |
...
| configType                      | Set the name of the type used for configuration                                                                               |          | NeureloAPISpecConfig                      |
...
| requestType                     | Set the name of the type used to generate requests                                                                            |          | NeureloAPISpecRequest                     |
...
| MODULE              | NOTES                                               |
| ------------------- | --------------------------------------------------- |
| NeureloAPISpec.Client    | use the "dispatch" functions to send requests       |
| NeureloAPISpec.Core      | core functions, config and request types            |
| NeureloAPISpec.API       | construct api requests                              |
| NeureloAPISpec.Model     | describes api models                                |
| NeureloAPISpec.MimeTypes | encoding/decoding MIME types (content-types/accept) |
| NeureloAPISpec.ModelLens | lenses for model fields                             |
| NeureloAPISpec.Logging   | logging functions and utils                         |
